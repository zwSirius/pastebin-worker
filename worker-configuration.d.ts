/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 3a46a689e40e4f5ba8d9edab3b86f7ee)
// Runtime types generated with workerd@1.20260710.1 2025-04-24 
interface __BaseEnv_Env {
	PB: KVNamespace;
	ASSETS: Fetcher;
	// optional: this deployment runs KV-only, R2 bucket is not bound
	R2?: R2Bucket;
	DEPLOY_URL: string;
	REPO: string;
